...
public class ApiClientFactory {
	 ...
	 * @param altitude
	 */
	public static void addUserLocation(Context context,Object controller,String methodName, Double latitude, Double longitude, Double altitude) {
		ParamsFormat pf=ParamsFormatFactory.getParamsFormat("MAddLocation");
		pf.addParam("latitude", latitude);
		pf.addParam("longitude", longitude);
		pf.addParam("altitude", altitude);
	...
	public static void getNearUsers(Context context,Object controller,String methodName, Integer range, Integer page, Integer limit, Double latitude, Double longitude, Double altitude) {
		ParamsFormat pf=ParamsFormatFactory.getParamsFormat("MNearUser", page, limit);
		pf.addParam("range", range);
		pf.addParam("latitude", latitude);
		pf.addParam("longitude", longitude);
		pf.addParam("altitude", altitude);
		
		MCourseList list = new MCourseList();
