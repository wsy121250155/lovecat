...
(function ($)
{
	$.fn.wipetouch = function (settings)
	{
		...
		var config = {
			...
			moveX: 1, 	// minimum amount of horizontal pixels to trigger a wipe event
			moveY: 1, 	// minimum amount of vertical pixels to trigger a wipe event
		...
		this.each(function ()
		{
			...
			{	
				...
				triggerEvent(config.wipeMoveEnd, {
					curX: curX,
					curY: curY
				});
			}
