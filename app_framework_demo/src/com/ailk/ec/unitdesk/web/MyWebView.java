...
public class MyWebView extends WebView {
	 ...
	 * @param defStyle
	 */
	public MyWebView(DroidGap context) {
		super(context);
	 ...
	 * @param defStyle
	 */
	public MyWebView(DroidGap context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = context;
		initWebViewClient();
	 ...
	 * @param defStyle
	 */
	public MyWebView(DroidGap context, AttributeSet attrs, boolean ownTouch) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = context;
	...
	private void initWebViewClient() {
		...
		this.setWebViewClient(new LocalWebViewClient(context));
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if (ownTouch) {
			...
			return ((LinearLayout) getParent()).onTouchEvent(ev);
		}
	}
