...
public abstract class PostRequest extends AsyncHttpResponseHandler
{
	...
	public String url;
	public PostRequest(Handler handler, int wwhat)
	{
	...
	/* (non-Javadoc)
	 * @see com.al.android.somsdesk.net.asyncClient.AsyncHttpResponseHandler#onSuccess(int, org.apache.http.Header[], byte[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.al.android.somsdesk.net.asyncClient.AsyncHttpResponseHandler#onFailure(int, org.apache.http.Header[], byte[], java.lang.Throwable)
	 */
	@Override
...
//	
	...
	public void upLoadFile(RequestParams paths)
	{
		...
		{
			// 网络不可用
			onFailure(0,new Header[0],new byte[0],new RequestException(
