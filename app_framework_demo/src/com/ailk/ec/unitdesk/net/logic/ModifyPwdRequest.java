...
public class ModifyPwdRequest extends HttpBaseRequest {

	public final String TAG = "ModifyPwdRequest";
	...
	public ModifyPwdRequest(Handler handler, int wwhat, String staffId,
