...
public class GetTemplateListRequest extends HttpBaseRequest {

	public final String TAG = "GetTemplateListRequest";
	...
	public GetTemplateListRequest(Handler handler, int wwhat, String userId,
	...
	public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
		...
		Log.e(resultStr, true);
		TemplateTypeResult result = gson.fromJson(resultStr,
