 ...
 * 
 */
public class QueryAllPostsRequest extends PortalRequest {

	public final String TAG = "QueryAllPostsRequest";
	...
	public QueryAllPostsRequest(Handler handler, int wwhat, String userId,
			String areaCode, String deviceType, long cateId, String actionCode) {
		super(handler, wwhat, cateId);
		this.userId = userId;
	...
	public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
		...
		try {
			...
			Log.e("所有词帖 ：  " + reusltStrObj.result, true);
			GetAllPostsResult allPosts = gson.fromJson(reusltStrObj.result,
					GetAllPostsResult.class);
			Message msg = Message.obtain();
			msg.what = wwhat;
			msg.obj = allPosts;
			Bundle data = new Bundle();
			data.putLong("cateId", instId);
			msg.setData(data);
