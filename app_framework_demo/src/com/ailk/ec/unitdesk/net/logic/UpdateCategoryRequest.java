...
public class UpdateCategoryRequest extends HttpBaseRequest {

	public final String TAG = "UpdateCategoryRequest";
	...
	public UpdateCategoryRequest(Handler handler, int wwhat, String userId,
			String areaCode, String deviceType, String ArrCategoryForUpdate,
			String url) {
		super(handler, wwhat);
		this.userId = userId;
